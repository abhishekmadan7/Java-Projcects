   ...
   class Widget implements Comparable<Widget>
   {
      ...
      {
         if (getPounds()*16 + getOunces() == w.getPounds()*16 + w.getOunces())
            return 0;
         else
            return (getPounds()*16 + getOunces()) - (w.getPounds()*16 + w.getOunces());
      }
   	public boolean equals(Widget arg)
      {
         if (getPounds() == arg.getPounds() && getOunces() == arg.getOunces())
            return true;
         else
            return false; 
      } 
      ...
      {
         return getPounds() + " lbs. " + getOunces() + " oz.";
      }
